...
const Writing = forwardRef<HTMLElement>(function Writing(_, ref) {
	return (
		<section ref={ref} id="writing" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" aria-label="Blog posts">
